...
inline float animspeed;
inline bool customize;
inline ImFont* tolstiy = nullptr;
inline ImFont* arialbd_13 = nullptr;
inline ImFont* arialbd_15 = nullptr;
...
public:
    ...
    float       TitleBarHeight() const  { ImGuiContext& g = *GImGui; return (Flags & ImGuiWindowFlags_NoTitleBar) ? 0.0f : CalcFontSize() + g.Style.FramePadding.y /** 5.0f*/; }
